...
# ADD nxserver.sh
RUN wget -O /nxserver.sh https://raw.githubusercontent.com/ramirezfx/opensuse-tumbleweed-desktop/0.0.1/nxserver.sh && chmod +x /nxserver.sh

# Custom Packages And Sripts:
RUN wget -O /custom.sh https://raw.githubusercontent.com/ramirezfx/opensuse-tumbleweed-desktop/0.0.1/custom.sh && chmod +x /custom.sh
RUN /custom.sh
